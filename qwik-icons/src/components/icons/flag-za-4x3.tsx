...
export const FlagZa4x3 = component$((props: IconProps) => {
  return (
    <Svg {...props} viewBox="0 0 640 480">
      <defs>
        <clipPath id="SVGXmBVUWUt">
          <path fill-opacity="0.7" d="M-71.9 0h682.7v512H-71.9z" />
        </clipPath>
      </defs>
      <g clip-path="url(#SVGXmBVUWUt)" transform="translate(67.4)scale(.93748)">
        <g fill-rule="evenodd" stroke-width="1">
          <path fill="#000001" d="M-71.9 407.8V104.4L154 256.1z" />
          <path fill="#000c8a" d="m82.2 512.1l253.6-170.6H696V512H82.2z" />
